// Implementation of a locking [`defmt::Logger`]. Sending bytes through the pluggable transport.
// Most of the code is taken from [defmt-itm](https://github.com/knurling-rs/defmt/tree/a6a2f87e18e29882627b6d1312ac17f3b5f37fbc/firmware/defmt-itm) under Apache 2.0 license / MIT license.
#![expect(unsafe_code)]
...
fn do_write(bytes: &[u8]) {
    crate::transport::write_bytes(bytes);
}
