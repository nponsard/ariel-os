...
const DEGREES_PER_METER_BASE: f64 = 360 / (EARTH_RADIUS * 2 * PI);
...
impl Nrf91Gnss {
    ...
    fn convert_to_samples(
        ...
        let latitude_accuracy = data.accuracy * DEGREES_PER_METER_BASE;
        ...
        let longitude_accuracy =
            data.accuarcy * DEGREES_PER_METER_BASE / data.latitude.to_radians().cos();
