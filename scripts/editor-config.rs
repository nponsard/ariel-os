...
#[derive(argh::FromArgs)]
/// Util to generate rust-analyzer configuration for Ariel OS
struct Args {
    #[argh(subcommand)]
    command: SubCommand,
}
...
impl From<Value> for serde_json::Value {
    fn from(value: Value) -> Self {
        match value {
            ...
            Value::Map(hash_map) => serde_json::Value::Object(serde_json::Map::from_iter(
                hash_map
                    .iter()
...
impl From<Value> for toml::Value {
    fn from(value: Value) -> Self {
        match value {
            ...
            Value::Map(hash_map) => toml::Value::Table(toml::Table::from_iter(
                hash_map
                    .iter()
