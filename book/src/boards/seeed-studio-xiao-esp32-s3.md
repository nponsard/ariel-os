...
- [Manufacturer link](https://web.archive.org/web/20260902130611/https://wiki.seeedstudio.com/xiao_esp32s3_getting_started/)

## laze Builders

For more information on laze builders, check out [this page](../build-system.md#laze-builders).

### `seeedstudio-xiao-esp32-s3`

- **Tier:** 3
- **Chip:** [ESP32-S3R8](../chips/esp32s3r8.md)
- **Chip Ariel OS Name:** `esp32s3r8`

To target this laze builder, run the following command in the root of your Ariel OS app:

```bash
laze build -b seeedstudio-xiao-esp32-s3
```
