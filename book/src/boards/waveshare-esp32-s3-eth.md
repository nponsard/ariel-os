...
- [Manufacturer link](https://web.archive.org/web/20260723193713/https://www.waveshare.com/wiki/ESP32-S3-ETH)
...
```bash
laze build -b waveshare-esp32-s3-eth
```
...
|Ethernet|<span title="supported">✅</span>|
